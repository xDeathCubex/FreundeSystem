    ...
    public void execute(CommandSender cs, String[] args) {
        ...
        if (args.length == 0) {
            ...
            for (String friends : freunde1) {
                if(!friends.equals("")) {
                    String name = UUIDFetcher.getName(UUID.fromString(friends));
            ...
            player.sendMessage(new TextComponent(MySQL.getProperties(player.getUniqueId().toString(), "invites") ? FreundeSystem.prefix+"Du kannst nun §awieder §7Freundschaftsanfragen §7erhalten.":
            ...
            player.sendMessage(new TextComponent(MySQL.getProperties(player.getUniqueId().toString(), "msgs") ? FreundeSystem.prefix+"Du erhälst nun §awieder §7private §7Nachrichten." :
            ...
            player.sendMessage(new TextComponent(MySQL.getProperties(player.getUniqueId().toString(), "jump") ? FreundeSystem.prefix+"Dir kann nun §awieder §7nachgesprungen §7werden." :
            ...
            player.sendMessage(new TextComponent(MySQL.getProperties(player.getUniqueId().toString(), "notifies") ? FreundeSystem.prefix+"Du erhälst §awieder §7Join/Leave §7Benachrichtungen." :
